        ...
        <div className="col-lg-4">
          <div className="card mb-4">
            <div className="card-body text-center" >
              <img src={products.image} alt="product" style={{height:'400px' , width:'300px' }}/>
            </div>
          </div>
        </div>
            ...
            <div className="card-body">
              <div className="row">
                <div className="col-sm-9">
                  <h4 className="mb-3" style={{color:'#104773'}}>{products.name}</h4>
              ...
              <div className="row">
                ...
                <div className="col-sm-9">
                  <p className="text-muted mb-0">{products.category}</p>
                </div>
              </div>
              <hr className="prodHr"/>
              <div className="row">
                ...
                <div className="col-sm-9">
                  <p className="mb-0 fw-bold" style={{color:'#0da8a7',fontWeight: 'bold'}}>{products.price} EG</p>
                </div>
              </div>
              <hr className="prodHr"/>
              <div className="row">
              ...
              <div className="row">
                ...
                <button type="button" className="btn mx-3 prodBtn" style={{border:'none' , outLine:'none' , boxShadow:'none' , color:'#fff' , fontWeight:'bold'}} onClick={()=>onAdd(products)}><i className="fa-solid fa-cart-shopping mx-2"></i><span>Add to cart</span></button>
